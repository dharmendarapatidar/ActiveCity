...
urlpatterns = [
    ...
    # Rest urls
    path('get_citizen/',views.CitizenGet.as_view()),
    path('post_citizen/',views.CitizenPost.as_view()),
    path('get_complaint/',views.ComplaintGet.as_view()),
    path('post_complaint/',views.ComplaintPost.as_view()),
    path('get_feedback/',views.FeedbackGet.as_view()),
    path('post_feedback/',views.FeedbackPost.as_view()),
